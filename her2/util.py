...
class Acer:
    ...
    def call(self, replay_start, nb_train_epoch):
        ...
        obs, next_obs, actions, ext_rewards, mus, dones, masks, int_rewards, goal_obs = self.adjust_shape(results)
        names_ops, values_ops = model.train_policy(
            obs, next_obs, actions, int_rewards, dones, mus, model.initial_state, masks, steps, goal_obs)
